...
public class RuleViewLine extends View{
    ...
    public RuleViewLine(Context c, AttributeSet a) {
        super(c, a);
        setFocusable(true);
    ...
    private void makeRule2Squares(){
        ...
        SquareView free = new SquareView(0,cellWidth,cellPad,freeP);
